...
# --- CONFIGURACIÓN ---
# Cambia esta variable a "RECTA", "CURVA""CIRCULO", "OCHO" o "CUADRADO"
FIGURA = "CURVA" 
...
while robot.step(TIME_STEP) != -1:
    ...
    # ----------------------------------------------------
        ...
        v_l = MAX_SPEED * 0.3
        v_r = MAX_SPEED * 0.8  # La rueda derecha va más rápido, gira a la izquierda
    # ----------------------------------------------------
    elif FIGURA == "CURVA":
        # Dibuja una curva suave durante los primeros 4 segundos
        if tiempo_actual < 4.0:
            # Una pequeña diferencia crea una curva abierta
            v_l = MAX_SPEED * 0.4
            v_r = MAX_SPEED * 0.6  
    ...
    # ----------------------------------------------------
        ...
        # Usamos el operador módulo (%) para alternar cada 6 segundos
    ...
    # ----------------------------------------------------
        ...
        # Si el estado es un número par (0, 2, 4, 6...), avanza en línea recta
        ...
        # Si el estado es un número impar (1, 3, 5, 7...), gira en el lugar
        else:
            v_l = -MAX_SPEED * 0.2
            v_r =  MAX_SPEED * 0.2
            
            # ¡ATENCIÓN! Este es el tiempo de giro. 
            # 1.25 segundos es una aproximación. Debes calibrarlo.
